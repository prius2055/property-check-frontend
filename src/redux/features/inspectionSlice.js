...
const url = 'https://propcheck-api.onrender.com/api/v1/inspections';
...
export const getUserInspections = createAsyncThunk(
  ...
  async (id) => {
    ...
    const response = await axios.get(
      `https://propcheck-api.onrender.com/api/v1/user_inspection/${id}`,
      {
        headers: {
          'content-type': 'application/json',
          authorization: authToken,
...
export const deleteInspection = createAsyncThunk(
  ...
  async (id) => {
    ...
    const response = await axios.delete(
      `https://propcheck-api.onrender.com/api/v1/inspections/${id}`,
      {
        headers: {
          'content-type': 'application/json',
          authorization: authToken,
