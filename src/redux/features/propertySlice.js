...
export const getProperties = createAsyncThunk('get/properties', async () => {
  ...
  const response = await axios.get('https://propcheck-api.onrender.com/api/v1/properties', {
    headers: {
...
export const addProperty = createAsyncThunk(
  ...
  async (propertyDetail) => {
    ...
    const response = await axios.post(
      'https://propcheck-api.onrender.com/api/v1/properties',
...
export const getSingleProperty = createAsyncThunk(
  ...
  async (id) => {
    ...
    const response = await axios.get(
      `https://propcheck-api.onrender.com/api/v1/properties/${id}`,
      {
        headers: {
          'content-type': 'application/json',
          authorization: authToken,
