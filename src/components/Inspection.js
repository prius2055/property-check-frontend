...
const Inspection = () => {
  return (
    <div className="flex h-screen bg-lime-500">
      <Navigation />
      <div className="flex flex-col justify-evenly items-center py-8 w-5/6 m-auto">
        ...
        <div className="w-1/2">
          <div className="flex justify-end mt-6 font-bold text-white">
          ...
          <img
            ...
            className="w-full h-1/2 rounded-lg m-auto"
          />
          <p className="mt-6 mb-10 text-white w-full text-center">
